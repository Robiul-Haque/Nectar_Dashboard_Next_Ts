...
export default function Sidebar({ isOpen, setIsOpen }: SidebarProps) {
    ...
    return (
        <>
            {/* Desktop Sidebar */}
            <aside className="hidden lg:flex w-72 flex-col border-r border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 h-screen sticky top-0">
                <div className="p-6">
            ...
            >
                {/* Same content as desktop - you can reuse or duplicate for simplicity */}
                <div className="p-6">
